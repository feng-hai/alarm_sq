 ...
 * details.
 */
package cn.wlwl.cube.ananlyse.spout.alarm;
...
import cn.wlwl.cube.analyse.filter.alarm.VehicleFilters;
import cn.wlwl.cube.ananlyse.functionsForAlarm.AnalysisAlarmDataFunction;
import cn.wlwl.cube.ananlyse.functionsForAlarm.CreateVehicleModelFunction;
import cn.wlwl.cube.ananlyse.functionsForAlarm.DeviceIDForAlarmFunction;
import cn.wlwl.cube.hbase.alarm.HBaseQueryVehicleFactoryAlarm;
import cn.wlwl.cube.hbase.alarm.HBaseVehicleUpdateAlarm;
...
public class TridentKafkaSpoutAlarm {
	...
	public StormTopology buildConsumerTopology(LocalDRPC drpc) {
		...
		tridentTopology.newStream("spoutVehicleAlarm", createKafkaSpout()).parallelismHint(3)
				...
				.each(new Fields("vehicle"), new VehicleFilters())
				...
				.partitionPersist(new HBaseQueryVehicleFactoryAlarm(), new Fields("vehicleInfo"), new HBaseVehicleUpdateAlarm())
				.parallelismHint(16);
