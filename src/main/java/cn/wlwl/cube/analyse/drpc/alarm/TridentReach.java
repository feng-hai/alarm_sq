 ...
 */
package cn.wlwl.cube.analyse.drpc.alarm;
...
//			conf.setNumWorkers(3);
			...
			// StormSubmitter.submitTopology(args[0] + "-consumer", conf,
			// kafkaInstance.buildConsumerTopology(null));

			StormSubmitter.submitTopology(args[0] + "-consumer", conf, buildTopology(null));
